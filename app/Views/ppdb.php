...
<body>
    ...
    <div class="container-fluid">
        <a class="navbar-brand" href="#">
            <img src="http://localhost/ci4download/public/tutwurihandayani.png" alt="Logo Navbar" style="height: 75px; width: auto;">
        </a>
    ...
    <div class="bagian">
        <div class="gambar">
            <img src="http://localhost/ci4download/public/gambar.png" alt="Logo Navbar" style="height: 500px; width: auto;">
        </div>
        <div class="container">
